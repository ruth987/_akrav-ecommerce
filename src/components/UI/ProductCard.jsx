...
<a href={`/shop/${item.product.id}`}>
    <img class="p-0 w-full h-56 rounded-t-lg" src={item.product.imgUrl} alt="product image" />
    </a>
<div class="px-5 pb-5">
<a href={`/shop/${item.product.id}`}>
        <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white py-3">{item.product.productName}</h5>
        </a>
